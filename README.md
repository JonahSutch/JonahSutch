...
🚀 What I'm About
I love working across the stack—from backend data pipelines to mobile UI/UX. Whether it's optimizing database queries, building predictive models, or refactoring component architectures, I'm driven by the challenge of making systems more efficient, reliable, and user-friendly.
💻 Technical Skills
...
Core Competencies: REST APIs • Unit Testing • Scalable Architecture • Data Structures & Algorithms • CI/CD Fundamentals
🔨 Featured Projects
...
Automated full data pipeline: ingestion → preprocessing → feature engineering → model training
